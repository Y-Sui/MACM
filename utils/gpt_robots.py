...
def generate_from_meta_reasoner(prompts, max_tokens, model="gpt-4o-mini", temperature=0.7, n=1):
    assistant = client.beta.assistants.create(
        model=model,
        instructions="""You are a Meta-reasoner, tasked with analyzing the reasoning process of another AI and providing guidance for its further steps. Your goal is to provide explicit guidance to improve the efficiency and effectiveness of the AI's problem-solving approach.""",
        name="Meta-reasoner",
        tools=[{"type": "code_interpreter"}],
    )
